					...
					<form role="form" action="privacyupdate.action" method="post">
						...
						<div> 
		                     <div class="form-group row">
		                        ...
		                        <input type="button" onclick="postcode()" class="btn col-md-1" style="width:120px;" value="우편번호 찾기">
		                     </div>
		                     <div class="form-group row">
						...
						<div class="form-group row">
							...
							<input type="tel" id="tel" name="tel" required="required" class="form-control" value="${member.tel }"/>
						</div>
						...
						<div class="form-group row">
							...
							<input type="tel" id="hometel" name="hometel" required="required" class="form-control" value="${member.hometel }"/>
						</div>
